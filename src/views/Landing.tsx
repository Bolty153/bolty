...
export default function Landing({ onEnter }: Props) {
  ...
  return (
    <div className="landing">
      ...
      {/* ===== DIFERENCIALES ===== */}
      <section className="lp-section tight" id="diferencial">
        <div className="lp-wrap">
          <Reveal>
            <div className="lp-head">
              <span className="lp-eyebrow">Por qué Bolty es diferente</span>
              <h2>Dos ventajas que muy pocos agentes tienen</h2>
              <p>Bolty llega a tus clientes donde estén y habla en su idioma. Sin que vos tengas que hacer nada.</p>
            </div>
          </Reveal>
          <div className="lp-dual-grid">
            <Reveal>
              <div className="lp-dual-card lp-dual-multi">
            ...
            <Reveal delay={130}>
              <div className="lp-dual-card lp-dual-lang">
                <span className="lp-dual-tag">Multi-idioma</span>
                <h3>Responde en el idioma de tu cliente</h3>
                <p>
                  ¿Te escriben en inglés, portugués o francés? Bolty detecta el idioma automáticamente
                  y contesta en ese mismo idioma. Ideal para negocios que atienden turistas o clientes del exterior.
                </p>
                <div className="lp-lang-row">
                  <span className="lp-lang-pill">🇦🇷 Español</span>
                  <span className="lp-lang-pill">🇺🇸 English</span>
                  <span className="lp-lang-pill">🇧🇷 Português</span>
                  <span className="lp-lang-pill">🇫🇷 Français</span>
                  <span className="lp-lang-pill">🇮🇹 Italiano</span>
                  <span className="lp-lang-pill">+ más</span>
                </div>
              </div>
            </Reveal>
          </div>
